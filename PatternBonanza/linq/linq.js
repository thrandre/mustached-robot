...
define(["require", "exports"], function(require, exports) {
    var EnumerableFactory = (function () {
        function EnumerableFactory() {
        }
        EnumerableFactory.prototype.fromArray = function (arr) {
            return Enumerable.fromArray(arr);
        };

        EnumerableFactory.prototype.fromObject = function (obj) {
            return Enumerable.fromObject(obj);
        };
        return EnumerableFactory;
    })();
    exports.EnumerableFactory = EnumerableFactory;
